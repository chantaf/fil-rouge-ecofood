...
const [email, setEmail] = useState(localStorage.getItem('email'));
    ...
    const checkAuth= async (e)=>{
      ...
      let url=`http://localhost:4000/api/clients/login`;
    ...
    return (
        ...
        <div className={classes.root}>
            <h3 className={classes.h3}> Vous Être un client</h3>

            <form onSubmit={e => {checkAuth(e)}}>

                    
          <TextField  id="standard-basic"name="email" type="email" label="Email" value ={email} className={classes.inputWidth} />
          ...
          <FormControlLabel  
            ...
            <a href="#" style={{textDecoration:"none",color:"#A8A8A7",fontSize:"17px"}}>Mot de passe oublié</a>
                  ...
                  <div style={{color:"#A8A8A7",fontSize:"17px"}} onClick={handelclick}>Vous êtes pas encore inscrir?  <p style={{textDecoration:"none",color:"#7CBD4F",fontSize:"17px"}} >S'inscrir ici</p> </div>
